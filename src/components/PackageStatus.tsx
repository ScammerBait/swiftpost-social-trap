  ...
  return (
    <Card className="p-6 mb-6 bg-gradient-to-r from-logistics-light to-white border-logistics-orange/20">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-lg font-semibold text-logistics-navy">iPhone 15 Pro Max Status</h3>
          <p className="text-sm text-muted-foreground">Tracking: <span className="font-mono font-medium">{trackingNumber}-CA-NG</span></p>
        </div>
        <Badge variant="outline" className="bg-logistics-orange text-white border-logistics-orange">
          ...
          <div key={index} className="flex items-center">
            <div className={`w-6 h-6 rounded-full flex items-center justify-center mr-3 ${
              step.completed 
                ...
                : index === 3 ? 'bg-logistics-orange text-white' : 'bg-gray-200 text-gray-400'
            }`}>
      ...
      <div className="mt-4 p-3 bg-logistics-red/10 border border-logistics-red/20 rounded-md">
        ...
        <p className="text-xs text-muted-foreground mt-1">
          Please verify your delivery information within the specified timeframe to complete the process.
        </p>
      </div>
    </Card>
  );
